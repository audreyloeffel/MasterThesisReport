...
\include{main/ch1_sparse_in_ml}
\include{main/ch2_dl4j}
\include{main/ch3_arrayStructure}

\include{main/ch4_implementation}
\include{main/ch5_operations}
\include{main/ch6_results}
\include{main/ch7_future}
...
\include{tail/runThrough}
\include{tail/runThroughTranslation}
\backmatter
\include{tail/biblio}
